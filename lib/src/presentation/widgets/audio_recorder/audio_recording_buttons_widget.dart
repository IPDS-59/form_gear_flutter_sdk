...
/// Buttons shown during active recording - pause and stop
class AudioRecordingButtonsWidget extends StatelessWidget {
  const AudioRecordingButtonsWidget({super.key});
